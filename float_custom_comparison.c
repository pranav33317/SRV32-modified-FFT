...
int main(void)
{
    ...
    char header[512], data_line[200000], filename[256];
    ...
    // {
    //     custom_float16_t cf = float_to_custom_float16(f);
    //     float back = custom_float16_to_float(cf);
    //     float err = fabsf(back - f);
    //     tot += err;
    //     c++;
    //     printf("Orig: %f, Reconstructed: %f, Error: %f\n", f, back, err);
    // }
    // printf("%f\n", tot / c);
    printf("%f %f\n", cmin, cmax);
    printf("%f %f\n", fmin, fmax);
